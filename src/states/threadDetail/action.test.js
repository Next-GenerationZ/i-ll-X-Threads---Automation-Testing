...
import {
  ...
  describe('async actions', () => {
    ...
    it('should dispatch receiveThreadDetail and hideLoading on asyncReceiveThreadDetail success', async () => {
      ...
      expect(dispatch).toHaveBeenCalledWith(receiveThreadDetailActionCreator(mockThreadDetail));
    ...
    it('should dispatch addComment and hideLoading on asyncCommentThreadDetail success', async () => {
      ...
      expect(dispatch).toHaveBeenCalledWith(addCommentActionCreator(mockComment));
      expect(dispatch).toHaveBeenCalledWith(hideLoading());
    });
    ...
    it('should dispatch toggleLikeCommentThread on asyncToogleLikeCommentThread success', async () => {
      ...
      // assert
      expect(dispatch).toHaveBeenCalledWith(showLoading());
      expect(dispatch).toHaveBeenCalledWith(toggleLikeCommentThreadActionCreator({ threadId: 'thread-1' }));
    ...
    it('should dispatch toggleNeutralThread on asyncToogleNeutralCommentThread success', async () => {
      ...
      // assert
      expect(dispatch).toHaveBeenCalledWith(showLoading());
      expect(dispatch).toHaveBeenCalledWith(toggleNeutralThreadActionCreator({ threadId: 'thread-1', commentId: 'comment-1' }));
    ...
    it('should dispatch toggleDisLikeCommentThread on asyncToogleDisLikeCommentThread success', async () => {
      ...
      // assert
      expect(dispatch).toHaveBeenCalledWith(showLoading());
      expect(dispatch).toHaveBeenCalledWith(toggleDisLikeCommentThreadActionCreator({ threadId: 'thread-1', commentId: 'comment-1' }));
